...
ExtentTest test;
String inputpath="D:\\NovemberBatchEveng\\Selenium_Frameworks\\TestInput\\Registerdata.xlsx";
String outputpath="D:\\NovemberBatchEveng\\Selenium_Frameworks\\TestOutput\\Register.xlsx";
File screen;
@BeforeTest
public void setUp()
{
report=new ExtentReports("./Reports/Webreg.html");
System.setProperty("webdriver.chrome.driver", "D:\\NovemberBatchEveng\\Selenium_Frameworks\\CommonDrivers\\chromedriver.exe");
...
FileUtils.copyFile(screen, new File("D:\\NovemberBatchEveng\\Selenium_Frameworks\\Screens\\Iteration"+i+"register.png"));
